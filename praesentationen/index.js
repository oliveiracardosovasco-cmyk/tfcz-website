/* ===== TFCZ · Register der Präsentationen =====
   ...
   Felder
     ...
     datei   Pfad zum Deck
     cover   Vorschaubild aus der Galerie (thumb/…) — referenziert, nie kopiert
...
window.TFCZ_PRAESI = [
  {
    ...
    cover: 'assets/fotos/galerie/thumb/1096.webp',
    folien: 14,
    dauer: '≈ 3 Min',
    text: 'Ansage am Turniermorgen: Disziplinen & Zeiten, Coral, Tempo, Stream auf Tisch 1+2, Hausregeln, Hitze, Bar, Parkieren, Preisgeld.'
  }
];
